...
class ChunkItems:
    ...
    """
    def __new__(cls) -> ChunkItems: ...    def push_entry(
        self,
        key: builtins.str,
        chunk_shape: typing.Sequence[builtins.int],
        shape: typing.Sequence[builtins.int],
...
class CodecPipelineImpl:
    def __new__(
        ...
        *,
        ...
        io_workers_max: builtins.int | None = None,
        codec_workers_max: builtins.int | None = None,
        max_workers: builtins.int | None = None,
    ...
    def retrieve_chunk_items_and_apply_index(
        ...
        io_workers: builtins.int | None = None,
        codec_workers: builtins.int | None = None,
